# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 20:55:59 2023
...
####------------------------> Esta funcion devuelve una lista tal cual: ejemplo [1 0] 
def tomarFichas():
                ...
                try:
                    ...
                    if turno2==True and len(fichas)!=0:
                        ...
                        if val5==1:
                            ...
                            while tomar==True:
                                ...
                                if pierde_jugador==True:
                                    print("Pierde el jugador por exceso de fichas")
                                    return True
                        ...
                        if val4-1<=6 and val4-1>=0:
                            ...
                            #pierde_jugador=True
                            print("Pierde el jugador por no colocar una ficha")
                            return True
...
def jugada(fichas3,num):
    ...
    if fichas3[num,0]!=9 and fichas3[num,1]!=9:
        if fichas3[num,0] == izq:
            ...
            print("Pierdes por colocar una ficha que no se puede")
            return True
...
def gana(fichas4,turno3):
    ...
    for i in range(len(fichas4)):
        if fichas4[i,0]==9:
            n=n+1
    if n==len(fichas4) and turno3 == True:
        print("Gana el jugador")
        return True
    elif n==len(fichas4) and turno3 == False:
        print("Gana el Bot")
        return True
...
def pierde(turno3):
    if turno3==True:
        print("Pierde el jugador por colocar una ficha que no va")
    elif turno3==False:
        print("Pierde el bot por colocar una ficha que no va")
